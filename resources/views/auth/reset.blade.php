        ...
        <div id="login-box" class="form-box">
            ...
            <form action="/password/reset" method="post">
                ...
                <div class="b-login__fields">
                    ...
                    <div class="form-group b-login__control">
                        <input class="b-login__field -icon_pass" autocomplete="off" required="required" placeholder="Password" type="password" name="password" />
                    </div>
                    <div class="form-group b-login__control">
                        <input class="b-login__field -icon_pass" autocomplete="off" required="required" placeholder="Confirm Password" type="password" name="password_confirmation" />
                    </div>
                </div>
                <div class="footer">                                                               
                    <button type="submit" class="b-login__btn ">Reset Password</button>  
