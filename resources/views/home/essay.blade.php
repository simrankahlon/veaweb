    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="col-md-12">
                <br><br>
                    <div class="col-md-12">
                       {!! Form::open(array('url' => 'student/essay','method'=>'GET','files' => true, 'class'=>'','id'=>'essayform')) !!}
                        ...
                        {!! Form::hidden('module','essay',array('id'=>'module'))!!}
                             ...
                             <tr>
                               ...
                               @foreach($essay as $w)                              
                                <tr>
                                    ...
                                    <a target="_blank" href="{{ URL::to('uploads/essay/' . $w->essaydoc) }}">
