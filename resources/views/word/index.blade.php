...
<div class="container main-content">
    ...
    <div class="row">
        <div class="col-md-10">Word Document</div>
        <div class="col-md-1"><a class="btn button-green" href="{{ URL::to('admin/word/create') }}">Add Document</a></div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <tbody>
                  @forelse($word as $c)
                    <tr>
                        ...
                        <td width="20%"><a target="_blank" href="{{ URL::to('uploads/word/' . $c->worddoc) }}"><img width="25" height="25" src="custom-theme/img/word.png"></a></td>
                        <td width="20%">{!! date('d-m-Y',strtotime($c->created_at)) !!}</td>
                        <td width="20%"> 
                            {!! Form::open(array('url' => 'word/' . $c->id,'name' => 'frmdel'.$c ->id, 'onsubmit'=> 'return confirm("Do you really want to delete?");')) !!}
                                    {!! Form::hidden('_method', 'DELETE') !!}
                           <a class="btn btn-xs btn-primary" href="{{ URL::to('word/' . $c->id .'/edit') }}"><span aria-hidden="true" class="glyphicon glyphicon-check"></span></a>                                                                   
