...
<div class="container main-content">
    ...
    <div class="errormsg"></div>
        {!! Form::open(array('url' => 'content/update/'.$content->id,'method'=>'POST', 'class'=>'','id'=>'contentform')) !!}
    <div class="row">
        <div class="col-md-2">
         ...
         <div class="col-md-8">
            <div class="form-group">
                {!! Form::text('title', $content->title, array('class' => 'form-control','required'=>"required",'id'=>"title", 'placeholder'=>"title")) !!}
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-8 col-xs-8">
            <div class="form-group">            
                <textarea name='paraone' rows="10" cols="15" class="form-control">{!! $content->paraone !!}</textarea>
            </div>
        </div>      
    </div>
    <div class="row">
