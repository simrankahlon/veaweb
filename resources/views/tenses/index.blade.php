...
<div class="container main-content">
    ...
    <div class="row">
        <div class="col-md-10">Tenses</div>
        <div class="col-md-1"><a class="btn button-green" href="{{ URL::to('tenses/create') }}">Add Tense</a></div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <table id="fun-table" class="table table-striped table-hover func_table">
                ...
                <tbody>
                  @forelse($tenses as $c)
                    <tr>
                        <td width="10%">{!! $c->title !!}</td>
                        <td width="40%">{!! $c->paraone !!}</td>
                        <td width="40%">{!! $c->paratwo !!}</td>
                        <td width="10%"> 
                            {!! Form::open(array('url' => 'tenses/' . $c->id,'name' => 'frmdel'.$c ->id, 'onsubmit'=> 'return confirm("Do you really want to delete?");')) !!}
                                    {!! Form::hidden('_method', 'DELETE') !!}
                            <a class="btn btn-xs btn-primary" href="{{ URL::to('tenses/' . $c->id .'/edit') }}"><span aria-hidden="true" class="glyphicon glyphicon-check"></span></a>                                                                        
