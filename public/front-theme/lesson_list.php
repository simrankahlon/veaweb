<?php 
	...
	$rs_member =  php_db_query(" select * from ". TABLE_LISTING."");
...
<div class="wrap">
  ...
  <section>
    <div class="col-xs-6">
      <div class="lesson-id row bodytext"><br>
        <?php
		$cnt=1;
	 while($arr_member = php_db_fetch_array($rs_member)) { ?>
        <ul>
          <li> <a href="lesson.php?ID=<?php echo $arr_member['contentid']; ?>"> <?php echo $arr_member['title']; ?> </a></li>
        </ul>
        <?php $cnt++; }  ?>
      </div>
      <div class="clear"></div>
