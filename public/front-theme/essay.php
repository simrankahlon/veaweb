<?php 
	...
	if(isset($_GET['std']))
	{
		$rs_member =  php_db_query(" select essaydoc,title,created from ". TABLE_ESSAY ." where stdid=".$_GET['std']."");
	}
	else if($_GET['ID'])
	{	
		$rs_member =  php_db_query(" select essaydoc,title,created from ". TABLE_ESSAY ." where ID=".$_GET['ID']."");		
	}
	else
	{
		$rs_member =  php_db_query(" select essaydoc,title,created from ". TABLE_ESSAY ."");
	}
?>
<!DOCTYPE HTML>
<html>
...
<ul class="menu">
                        ...
                        <li><a href="lesson_list.php">PREPOSITIONS EXERCISE</a></li>
                        <li><a href="word.php?std=1">DOWNLOADABLE WORD FILES</a></li>
                        <li class="active"><a href="essay.php?std=1">ESSAY</a></li>
</ul>
...
<section>
        ...
        <div class="lesson-id"><br>
                	...
                	<ul>
                    	<li><a href="essay.php?std=1">Standard 8 </a></li>
                        <li><a href="essay.php?std=2">Standard 9 </a></li>
                        <li><a href="essay.php?std=3">Standard 10 </a></li>
...
<div class="row bodytext word-download"><ul>
				...
				?>
                    ...
                    <?php echo $cnt; ?>
                    <a target="_blank" href="<?php echo DIR_WS_UPLOAD.$arr_member['essaydoc']; ?>"><br>
